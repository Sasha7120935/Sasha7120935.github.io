<?php
/**
 * The page for displaying single-page.
 *
					...
					<div class="container-main single-main">
						<div class="col-md-12">
							<div class="block-main mb-30">
								<img src="../assets/images/blog-post-big.jpg" class="img-responsive" alt="reviews2">
									...
									<ul class="entry-comments-list list-unstyled">
										<li>
											<div class="entry-comments-item">
												<img src="../assets/images/avatar.jpg" class="entry-comments-avatar" alt="">
